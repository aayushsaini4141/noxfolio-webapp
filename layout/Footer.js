          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-5">
              <div className="footer-widget widget_contact_info wow fadeInUp delay-0-6s">
                ...
                <ul>
                  <li>
                    <i className="far fa-map-marker-alt" /> {data.about.address}
                  </li>
                  <li>
                    <i className="far fa-envelope" />{" "}
          ...
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              <ul className="footer-bottom-nav">
                <li>
                  <a href="#">{data.social_handles[0].platform}</a>
                </li>
                <li>
                <a href="#">{data.social_handles[1].platform}</a>
                </li>
                <li>
                <a href="#">{data.social_handles[2].platform}</a>
                </li>
                <li>
                <a href="#">{data.social_handles[3].platform}</a>
                </li>
              </ul>
            </div>
          </div>
